...
const HBRLayoutPage = ({ doctors }) => {
  ...
  useEffect(() => {
    const filtered = doctors.filter((doctor) => doctor.location === 'HBR Layout');
  ...
  return (
    ...
    <div>
      ...
      <h1 className={styles.header}>HBR Layout</h1>
      
      <div className={styles.locationimgwrap}>
            <Image src="/images/img/banner/HBR.png" className={styles.locationimg}  alt="hbr" height={500} width={1200}/>
            </div>
