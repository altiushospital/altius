...
const HBRLayoutPage = ({ doctors }) => {
  ...
  useEffect(() => {
    const filtered = doctors.filter((doctor) => doctor.location === 'Rajarajeshwari Nagar');
  ...
  return (
    ...
    <div>
      ...
      <h1 className={styles.header}>Rajarajeshwari Nagar</h1>
      
      <div className={styles.locationimgwrap}>
            <Image src="/images/img/banner/rrnagar.png" className={styles.locationimg}  alt="Rajarajeshwari Nagar" height={500} width={1200}/>
            </div>
        <div className={styles.locationwrap}>
      <h1 className={styles.locationhead}>{"HBR Layout- Bangalore"}</h1>
